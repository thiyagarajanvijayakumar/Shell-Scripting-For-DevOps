...
# Consolidated Zabbix Installation and Mattermost Webhook Alerts Configuration Script for Raspberry Pi (Debian 12/Bookworm)
...
# Set variables from provided inputs
DB_PASSWORD="R^s.<2qcc<mTXGBy"
TIMEZONE="Asia/Kolkata"
MATTERMOST_URL="https://chat.pheonixsolutions.com/hooks/rpxwunk59tnd3eawfkuj5hraba"
SEND_TO="xb1mmswkb3f1f8yehd4sz8e1qo" # Channel ID for prod-alerts-from-zabbix
...
echo "Starting Zabbix installation and Mattermost webhook configuration..."
...
# Install jq for JSON parsing (needed for Zabbix API calls)
echo "Installing jq..."
...
2. Set Up Mattermost Incoming Webhook:
   ...
   - Copy the webhook URL (already provided: $MATTERMOST_URL).
